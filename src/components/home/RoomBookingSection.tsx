  ...
  return (
    <div style={{ marginBottom: 24, ...style }}>
      ...
      <Modal
        ...
        title={
          <div style={{ color: '#fff', fontSize: 15, fontWeight: 700, borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: 6 }}>
        ...
        styles={{
          ...
          body: {
            ...
            flex: 1,
            maxHeight: isMobile ? 'calc(100vh - 48px)' : 'calc(92vh - 48px)',
            overflowY: 'auto',
            paddingRight: 4,
            marginTop: 6
          },
            ...
            {(() => {
              ...
              return (
                <div style={{ marginBottom: 8 }}>
                  ...
                  {/* Visual Clickable Grid in 4 Columns */}
                  <div style={{
                    display: 'grid',
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: seg.isSelected ? '0 2px 8px rgba(244,175,37,0.2)' : 'none'
                          }}
                        >
                  ...
                  {/* Color keys legend */}
                  <div style={{ display: 'flex', justifyContent: 'center', gap: '6px 10px', fontSize: 8, color: 'rgba(255,255,255,0.4)', marginTop: 6, flexWrap: 'wrap' }}>
              ...
              return (
                <>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.04)', paddingBottom: 4 }}>
                      <div>
                        ...
                        {myExistingBooking ? (
                          <>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 10 }}>
                              ...
                              <span style={{ color: '#FFD700', fontWeight: 700, fontSize: 12 }}>{netPointsRequired} {t('roomBooking.points')}</span>
                            </div>
                          </>
                        ) : (
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 10 }}>
                            <span style={{ color: 'rgba(255,255,255,0.6)' }}>{t('roomBooking.depositRequired')}</span>
                            <span style={{ color: '#FFD700', fontWeight: 700, fontSize: 12 }}>{depositFee} {t('roomBooking.points')}</span>
                          </div>
                        )}
